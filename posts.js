const posts = [
   ...
   { 
        category: "JS",
        title: "Складываем два числа и возвращаем их сумму в двоичном виде.", 
        prevContent: "Реализация функции в JavaScript, которая складывает два числа и возвращает их сумму в двоичном виде. ", 
        content: `Реализация функции в JavaScript, которая складывает два числа и возвращает их сумму в двоичном виде. 
                  Преобразование может быть выполнено до или после добавления.
                  Возвращаемое двоичное число должно быть строкой.<br><br>
                    <b>
                         const addBinary = (a,b) => (a + b).toString(2);<br>
                         console.log(addBinary(5,5)); //1010<br><br>
                    </b>
                    Этот код сначала складывает два числа, а затем преобразует сумму в двоичное число в виде строки с помощью метода toString(2).
        `,
