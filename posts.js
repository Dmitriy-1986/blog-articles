const posts = [
   ...
   { 
        category: "JS",
        title: "Принимает логическое значение и возвращает 'Yes' для true и 'No' для false ", 
        prevContent: " ", 
        content: ` Метод, который принимает логическое значение и возвращает 'Yes' для true и 'No' для false. 
                    <br><br>
                    <b>
   ...
   { 
    ...
    { 
        category: "JS",
        title: "Функция, которая может преобразовать число (целое) в строку.", 
        prevContent: "Способы достижения цели преобразования числа в строку", 
        content: `Способы достижения цели преобразования числа в строку:
                    <br><br>
                    <b>
                  ...
                  С помощью конкатенации (соединения) числа со строкой пустого значения ''. 
                  Когда вы используете оператор + для соединения числа с пустой строкой, JavaScript автоматически выполняет 
                  преобразование числа в строку.
                   <b>
                   function numberToString(num) {<br>
                   &#160 &#160 return num + '';<br>
                  }
                  </b><br>
                   Эти способы работают преобразуют числовое значение в его строковый эквивалент.
        `,
        date:  '15.09.2023, 11:58:43'
    },
   { 
        category: "JS",
        title: "Банкоматы допускают использование 4- или 6-значных PIN-кодов.", 
        prevContent: "PIN-коды не могут содержать ничего, кроме ровно 4 или ровно 6 цифр.", 
        content: `PIN-коды не могут содержать ничего, кроме ровно 4 или ровно 6 цифр.
                  Если функции передана действительная строка PIN-кода, return true, иначе return false.
                    <br><br>
                    <b>
                    function validatePIN(pin) {<br>
                    &#160 &#160  // Используем регулярное выражение для проверки строки на соответствие<br>
                    &#160 &#160 // 4 или 6 цифрам и ничему другому.<br>
                    &#160 &#160 const regex = /^[0-9]{4}$|^[0-9]{6}$/;<br>
                    &#160 &#160  // Проверяем, соответствует ли введенная строка регулярному выражению.<br>
                    &#160 &#160  return regex.test(pin);<br>
                    }<br><br>
                    // Примеры использования:<br>
                    console.log(validatePIN("1234"));   // true <br>
                    console.log(validatePIN("12345"));  // false <br>
                    </b><br>
                    Этот код использует регулярное выражение /^[0-9]{4}$|^[0-9]{6}$/, которое означает следующее:<br>
                    ^ - начало строки.<br>
                    [0-9] - любая цифра от 0 до 9.<br>
                    {4} - точно 4 повторения предыдущего символа (цифры).<br>
                    | - оператор "или".<br>
                    [0-9]{6} - точно 6 цифр.<br>
                    $ - конец строки.<br><br>
                    Это выражение гарантирует, что строка должна быть либо ровно из 4 цифр, либо ровно из 6 цифр, 
                    и ничего, кроме цифр, не допускается.<br><br>
                    Функция validatePIN() в одну строку выглядит коротко и ясно
                   <b>
                    const validatePIN = (pin) => (/^[0-9]+$/).test(pin) ? (pin.length === 4 || pin.length === 6) : false;
                   </b><br>
                   Эта функция использует стрелочное выражение и тернарный оператор, чтобы проверить строку PIN-кода на 
                   соответствие условиям (состоит только из цифр и имеет длину 4 или 6 символов) и вернуть true или false 
                   в зависимости от результата проверки.
        `,
        date:  '15.09.2023, 13:42:36'
    },
   { 
        category: "JS",
        title: "Код для управления светофорами вашего города.", 
        prevContent: "Функция для обработки каждого изменения от green, до yellow, до red и затем green снова.", 
        content: `Функция для обработки каждого изменения от green, до yellow, до red и затем green снова и принимает строку 
                 в качестве аргумента, представляющую текущее состояние источника света, и возвращает строку, представляющую 
                 состояние, в которое должен перейти источник света. Например, если на входе green, на выходе должно быть yellow.
                    <br><br>
                    <b>
                    function changeTrafficLight(currentState) {<br>
                    &#160 &#160 switch (currentState) {<br>
                    &#160 &#160 &#160 &#160 case "green": <br>
                    &#160 &#160 &#160 &#160 &#160 &#160 return "yellow";<br>
                    &#160 &#160 &#160 &#160 case "yellow":<br>
                    &#160 &#160 &#160 &#160 &#160 &#160 return "red";<br>
                    &#160 &#160 &#160 &#160 case "red":<br>
                    &#160 &#160 &#160 &#160 &#160 &#160 return "green";<br>
                    &#160 &#160 &#160 &#160 default:<br>
                    &#160 &#160 &#160 &#160 &#160 &#160 return "Invalid state";<br>
                    &#160 &#160 }<br>
                    }<br><br>
                    // Пример использования:<br>
                    const currentLight = "green";<br>
                    const nextLight = changeTrafficLight(currentLight);<br>
                    console.log(\`Текущий свет: $\{currentLight}, следующий свет: $\{nextLight}\`);<br>
                    </b><br>
                    Можно записать эту функцию в одну строку, используя тернарные операторы.
                   <b>
                    const updateLight = current => current === 'yellow' ? 'red' : current === 'green' ? 'yellow' : 'green';
                   </b><br>
                   Эта версия функции updateLight делает то же самое, что и предыдущая версия, 
                   но в более компактной форме с использованием тернарных операторов.
        `,
        date:  '15.09.2023, 14:08:37'
    },
   { 
        category: "JS",
        title: "Задано неотрицательное целое число, верните строку с ропотом.", 
        prevContent: 'Создать строку с ропотом "1 sheep...2 sheep...3 sheep..." и так далее', 
        content: `Создать строку с ропотом "1 sheep...2 sheep...3 sheep..." и так далее,
                    начиная с 1 и заканчивая введенным числом. Вот как это можно сделать:
                    <br><br>
                    <b>
                     ...
                     Этот код создаст строку, в которой будут перечислены "овцы" с номерами от 1 до введенного числа num, 
                     каждая "овца" будет разделена троеточием.
        `,
   ...
   { 
        category: "JS",
        title: "Код купона", 
        prevContent: 'Ваш интернет-магазин любит раздавать купоны для особых случаев.', 
        content: `Ваш интернет-магазин любит раздавать купоны для особых случаев.
                    Некоторые клиенты пытаются обмануть систему, вводя неверные коды или используя купоны с истекшим сроком действия.
                    Написать функцию checkCoupon, которая проверяет, что код купона действителен и срок его действия не истек.
                    Купон перестает действовать на следующий день ПОСЛЕ истечения срока его действия. Все даты будут переданы в
                    виде строк в следующем формате: "MONTH DATE, YEAR".<br><br>
                    Для решения этой задачи, нужно сначала преобразовать строки с датами в объекты JavaScript Date 
                    и затем выполнить проверки на корректность кода купона и срока его действия. 
                    <br><br>
                    <b>
                       function checkCoupon(enteredCode, correctCode, currentDate, expirationDate){ <br>
                       &#160 &#160 // Преобразуем строки с датами в объекты Date <br>
                       &#160 &#160 const currentDateObj = new Date(currentDate); <br>
                       &#160 &#160 const expirationDateObj = new Date(expirationDate); <br><br>
                       &#160 &#160 // Проверяем код купона и срок его действия <br>
                       &#160 &#160 if (enteredCode === correctCode && currentDateObj <= expirationDateObj) { <br>
                       &#160 &#160 &#160 &#160 return true; // Купон действителен <br>
                       &#160 &#160 } else { <br>
                       &#160 &#160 &#160 &#160 return false; // Купон недействителен <br>
                       &#160 &#160 } <br>
                       } <br>
                       // Примеры использования <br>
                       console.log(checkCoupon("123", "123", "July 9, 2015", "July 9, 2015"));  // true <br>
                       console.log(checkCoupon("123", "123", "July 9, 2015", "July 2, 2015"));  // false <br>
                    </b><br>
                    Эта функция сравнивает введенный код купона с правильным кодом и проверяет, 
                    что текущая дата не превышает дату истечения срока действия купона.
        `,
        date:  '18.09.2023, 10:56:28'
    },
    { 
        category: "JS",
        title: "Проверка, что дата не соответствует с текущей датой без учета времени", 
    ...
    { 
        category: "JS",
        title: "Функция разности, которая вычитает один список из другого и возвращает результат.", 
        prevContent: 'Удалить все значения из списка (a), которые присутствуют в списке (b), сохраняя их порядок.', 
        content: `Удалить все значения из списка (a), которые присутствуют в списке (b), сохраняя их порядок.
